...
{
public:
	NodeAVL(int codigoDoProduto,string nome,int quantidade,float valorUnitario ,const std::string& data, NodeAVL* parent = nullptr, NodeAVL* left = nullptr, NodeAVL* right = nullptr);
	~NodeAVL();
